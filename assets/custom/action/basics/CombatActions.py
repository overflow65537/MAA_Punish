...
class CombatActions(CustomAction):
    ...
    def run(self, context: Context, argv: CustomAction.RunArg) -> CustomAction.RunResult:
        ...
        try:
            ...
            # 测试内容
            target = self.Arrange_Signal_Balls(context,  "any", {
    ...
    @staticmethod
    def Arrange_Signal_Balls(context: Context, target_ball: str, template: dict):
        BALL_POSITIONS = [
        ...
        def _find_optimal_ball( ball_list: list, target: str) -> int:
            ...
            if result := _check_combo_opportunity(ball_list, valid_length, is_any, target):
                return result
        ...
        def _check_triple_direct(ball_list: list, valid_length: int, 
        ...
        def _check_combo_opportunity(ball_list: list, valid_length: int,
                                is_any: bool, target: str) -> int:
            """检查连击机会"""
            candidate = 0
